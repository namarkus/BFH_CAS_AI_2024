...
if __name__ == "__main__":
    ...
    CONFIG_NAME = f'{ENVIRONMENT_ID}_a2c_{ENVIRONMENT_COUNT}envs_lr{LEARNING_RATE}_bs{BATCH_SIZE}_{REWARD_STEPS}rs'
    ...
    net = model.ModelA2C(env.observation_space.shape[1], env.action_space.shape[0]).to(FASTEST_DEVICE)
    print(net)
